...
public class Securityconfig {
    ...
    @Autowired
    @Lazy // Injeta o filtro JWT de forma atrasada para evitar problemas de inicialização
          // circular
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        // Resource Sharing) para permitir requisições de diferentes origens
        // .authorizeHttpRequests(auth -> auth
        // .requestMatchers("/auth/login", "/api/usuarios",
        // ).permitAll() // Permite acesso público às rotas de
        ...
        http
                ...
                .cors(cors -> cors.configure(http)) // Configura o CORS (Cross-Origin Resource Sharing) para permitir
