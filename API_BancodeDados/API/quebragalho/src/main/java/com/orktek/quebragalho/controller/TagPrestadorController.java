...
public class TagPrestadorController {
    ...
    @Operation(summary = "Adiciona uma tag a um prestador", 
               description = "Associa uma tag existente a um prestador específico.")
    ...
    @Operation(summary = "Remove uma tag de um prestador", 
               description = "Desassocia uma tag de um prestador específico.")
    ...
    @Operation(summary = "Lista tags de um prestador", 
               description = "Retorna uma lista de IDs de tags associadas a um prestador específico.")
