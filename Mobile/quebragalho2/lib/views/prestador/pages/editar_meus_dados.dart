  ...
  Future<void> carregarDados() async {
    ...
    try {
      ...
      final prestadorResp = await http.get(
        Uri.parse(
          'https://${ApiConfig.baseUrl}/api/prestador/perfil/$idPrestador',
        ),
      );
  ...
  Future<void> salvarDados() async {
    ...
    if (horaInicioSelecionada == null || horaFimSelecionada == null) {
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(const SnackBar(content: Text('Preencha os horários!')));
      return;
    }
    if (_horaToInt(horaFimSelecionada!) <= _horaToInt(horaInicioSelecionada!)) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('O horário de fim deve ser maior que o de início.'),
        ),
      );
      return;
    }
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      DropdownButtonFormField<String>(
                        ...
                        onChanged:
                            (value) =>
                                setState(() => horaInicioSelecionada = value),
                        decoration: InputDecoration(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      DropdownButtonFormField<String>(
                        ...
                        onChanged:
                            (value) =>
                                setState(() => horaFimSelecionada = value),
                        decoration: InputDecoration(
                          border: const UnderlineInputBorder(),
                          contentPadding: const EdgeInsets.symmetric(
                            horizontal: 8,
