...
class _PerfilPageState extends State<PerfilPage> {
  ...
  Future<void> carregarDados() async {
    ...
    if (id != null) {
      if (mounted) setState(() => idPrestador = id);
  ...
  // CORRIGIDO: Método original para migrar para cliente, agora com a estrutura correta.
  ...
  // CORRIGIDO: Este método estava dentro do método anterior. Agora está no escopo correto da classe.
  Future<String?> _uploadImagemApi(int usuarioId, File imagem) async {
    ...
    // CORRIGIDO: Adicionado parêntese de fechamento ausente
  ...
  // CORRIGIDO: Função de diálogo renomeada e consertada para confirmar a remoção de um serviço.
  void _confirmarDesabilitarServico(int idServico) {
    showDialog(
      context: context,
      builder: (context) => AlertDialog(
        title: const Center(
        ...
        actions: [
          ...
          ElevatedButton(
            ...
            onPressed: () {
              ...
              desabilitarServico(idServico); // Chama a função correta
            },
  ...
  Widget build(BuildContext context) {
    ...
    final descricao = prestador?['descricao'] ?? 'Sem descrição.';
    final idUsuario = prestador?['usuario']?['id'];
    final imagemUrl = idUsuario != null
        ? 'https://${ApiConfig.baseUrl}/api/usuario/$idUsuario/imagem' // Removido o timestamp para usar o cache do Flutter
        : null;
    ...
    return Scaffold(
      ...
      body: RefreshIndicator(
        ...
        child: ListView(
          ...
          children: [
            // ... (Restante do seu código do body que já estava correto)
                  ...
                  children: [
                    CircleAvatar(
                      ...
                      backgroundImage: _imagemSelecionada != null
                          ...
                          : (imagemUrl != null
                              // Adicionamos uma chave para forçar o redownload quando a URL muda (após o upload)
                              ? NetworkImage('$imagemUrl?key=${DateTime.now().millisecondsSinceEpoch}')
            ...
            ElevatedButton.icon(
              // Corrigido para a página correta, se o nome for diferente, ajuste aqui.
              onPressed: () => _navegarEAtualizar(PortfolioUploadPage()),
              icon: const Icon(Icons.add_photo_alternate),
              label: const Text("Adicionar ao Portfólio"),
            ),
            const SizedBox(height: 16),
            if (portfolio.isNotEmpty) ...[
              const Text("Meu Portfólio", style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
              ...
              GridView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final imagemUrl = 'https://${ApiConfig.baseUrl}${imagem['caminho']}';
                  return Stack(
                    fit: StackFit.expand,
                    children: [
                      ClipRRect(
            ...
            Text("Serviços cadastrados", style: Theme.of(context).textTheme.titleLarge),
            ...
            ...servicos.map<Widget>((servico) {
              ...
              return ServicoCard(
                ...
                tags: tagsServico,
                // CORRIGIDO: Chama a nova função de diálogo de confirmação
                onDelete: () => _confirmarDesabilitarServico(servico['id']),
