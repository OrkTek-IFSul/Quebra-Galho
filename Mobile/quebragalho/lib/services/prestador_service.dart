...
class PrestadorService {
  ...
  static Future<Prestador> criarPrestador(Map<String, dynamic> data, String url) async {
    try {
      ...
      if (response.statusCode == 200) {
        return Prestador.fromJson(jsonDecode(response.body)); // Retorna o prestador criado
      } else {
  ...
  static Future<Prestador> atualizarPrestador(int id, Map<String, dynamic> data, String url) async {
    try {
      ...
      if (response.statusCode == 200) {
        return Prestador.fromJson(jsonDecode(response.body)); // Retorna o prestador atualizado
      } else {
